...
| `SPOTIFY_REQUEST_INTERVAL_MS` | `1000` | Minimum interval in milliseconds between Spotify API requests. Lower values import faster but are more likely to trigger long Spotify cooldowns. |
